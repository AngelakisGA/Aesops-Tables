<template>
  <div class="oneCard" v-bind:class="{liked: restaurant.liked}">
      ...
      <img v-if="restaurant.photoUrl == ''" src="../assets/images/restaurant-default.jpg" />
      <img v-bind:src="restaurant.photoUrl" />
      <h3>Rating: {{restaurant.rating}}</h3>
       <span class="dollar-sign" v-if="restaurant.cost === 1"> Price: $</span>
              <span class="dollar-sign" v-else-if="restaurant.cost === 2">Price: $$</span>
              <span class="dollar-sign" v-else-if="restaurant.cost === 3">Price: $$$</span>
              <span class="dollar-sign" v-else-if="restaurant.cost === 4">Price: $$$$</span>
              <span class="dollar-sign" v-else>Price: $$$$$</span>
